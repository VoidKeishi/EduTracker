...
})({"4iOC0":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "f29995054510300f";
"use strict";
...
},{}],"jeTEc":[function(require,module,exports) {
/******************************************************************************
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */ const t$2 = globalThis, e$8 = t$2.ShadowRoot && (void 0 === t$2.ShadyCSS || t$2.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, s$3 = Symbol(), o$7 = new WeakMap();
let n$7 = class n {
    constructor(t, e, o){
...
const r$7 = (t)=>new n$7("string" == typeof t ? t : t + "", void 0, s$3), i$4 = (t, ...e)=>{
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */ const { is: i$3, defineProperty: e$7, getOwnPropertyDescriptor: r$6, getOwnPropertyNames: h$1, getOwnPropertySymbols: o$6, getPrototypeOf: n$6 } = Object, a$2 = globalThis, c$1 = a$2.trustedTypes, l$3 = c$1 ? c$1.emptyScript : "", p$1 = a$2.reactiveElementPolyfillSupport, d$1 = (t, s)=>t, u$2 = {
    toAttribute (t, s) {
        switch(s){
            case Boolean:
                t = t ? l$3 : null;
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */ const t$1 = globalThis, i$2 = t$1.trustedTypes, s$2 = i$2 ? i$2.createPolicy("lit-html", {
    createHTML: (t)=>t
}) : void 0, e$3 = "$lit$", h = `lit$${Math.random().toFixed(9).slice(2)}$`, o$3 = "?" + h, n$3 = `<${o$3}>`, r$1 = document, l$2 = ()=>r$1.createComment(""), c = (t)=>null === t || "object" != typeof t && "function" != typeof t, a$1 = Array.isArray, u$1 = (t)=>a$1(t) || "function" == typeof t?.[Symbol.iterator], d = "[ 	\n\f\r]", f$1 = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, v = /-->/g, _ = />/g, m$1 = RegExp(`>|${d}(?:([^\\s"'>=/]+)(${d}*=${d}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`, "g"), p = /'/g, g = /"/g, $ = /^(?:script|style|textarea|title)$/i, y = (t)=>(i, ...s)=>({
            _$litType$: t,
            strings: i,
            values: s
...
const P = (t, i)=>{
    ...
    for(let i = 0; i < s; i++){
        ...
        l += c === f$1 ? s + n$3 : d >= 0 ? (o.push(a), s.slice(0, d) + e$3 + s.slice(d) + h + x) : s + h + (-2 === d ? i : x);
    }
    return [
        C(t, l + (t[s] || "<?>") + (2 === i ? "</svg>" : "")),
        o
            ...
            if (1 === r.nodeType) {
                ...
                if ($.test(r.tagName)) {
                    ...
                    if (s > 0) {
                        ...
                        for(let i = 0; i < s; i++)r.append(t[i], l$2()), E.nextNode(), d.push({
                            type: 2,
                            index: ++c
                        });
                        r.append(t[s], l$2());
...
class M {
    ...
    k(t) {
        ...
        const i = this._$AH;
        let s, e = 0;
        for (const h of t)e === i.length ? i.push(s = new M(this.S(l$2()), this.S(l$2()), this, this.options)) : s = i[e], s._$AI(h), e++;
 ...
 */ function requestUpdateOnAriaChange(ctor) {
    for (const ariaProperty of ARIA_PROPERTIES)ctor.createProperty(ariaProperty, {
 ...
 */ function redispatchEvent(element, event) {
    ...
    if (event.bubbles && (!element.shadowRoot || event.composed)) event.stopPropagation();
    const copy = Reflect.construct(event.constructor, [
        event.type,
        event
    ]);
    ...
    class ConstraintValidationElement extends base {
       ...
       */ this[_a] = "";
        ...
        [(_a = privateCustomValidationMessage, privateSyncValidity)]() {
            if (!this[privateValidator]) this[privateValidator] = this[createValidator]();
 ...
 */ function mixinFormAssociated(base) {
    ...
    /** @nocollapse */ FormAssociatedElement.formAssociated = true;
    __decorate([
        n$5({
            noAccessor: true
        })
 ...
 */ class Validator {
   ...
   */ getValidity() {
        ...
        if (!hasStateChanged) return this.currentValidity;
 ...
 */ class Checkbox extends checkboxBaseClass {
     ...
     */ this.value = "on";
        ...
        this.addEventListener("click", (event)=>{
            if (!isActivationClick(event) || !this.input) return;
            this.focus();
...
/** @nocollapse */ Checkbox.shadowRootOptions = {
 ...
 */ class Chip extends s$1 {
   ...
   */ get rippleDisabled() {
    ...
    focus(options) {
        if (this.disabled && !this.alwaysFocusable) return;
        super.focus(options);
    }
    render() {
        return x`
    ...
    updated(changed) {
        if (changed.has("disabled") && changed.get("disabled") !== undefined) this.dispatchEvent(new Event("update-focus", {
            bubbles: true
        }));
    }
    getContainerClasses() {
...
/** @nocollapse */ Chip.shadowRootOptions = {
    ...s$1.shadowRootOptions,
    delegatesFocus: true
};
__decorate([
 ...
 */ class AssistChip extends Chip {
    ...
    renderOutline() {
        if (this.elevated) return x`<md-elevation part="elevation"></md-elevation>`;
 ...
 */ class ChipSet extends s$1 {
    ...
    handleKeyDown(event) {
        ...
        while(nextIndex !== currentIndex){
            if (nextIndex >= chips.length) // Return to start if moving past the last item.
            nextIndex = 0;
            else if (nextIndex < 0) // Go to end if moving before the first item.
 ...
 */ class MultiActionChip extends Chip {
    get ariaLabelRemove() {
        if (this.hasAttribute(ARIA_LABEL_REMOVE)) return this.getAttribute(ARIA_LABEL_REMOVE);
        const { ariaLabel } = this;
        return `Remove ${ariaLabel || this.label}`;
    }
    set ariaLabelRemove(ariaLabel) {
        const prev = this.ariaLabelRemove;
        if (ariaLabel === prev) return;
        if (ariaLabel === null) this.removeAttribute(ARIA_LABEL_REMOVE);
        else this.setAttribute(ARIA_LABEL_REMOVE, ariaLabel);
        this.requestUpdate();
    }
    constructor(){
        super();
    ...
    handleKeyDown(event) {
        ...
        if (!this.primaryAction || !this.trailingAction) // Does not have multiple actions.
        return;
        // Check if moving forwards or backwards
        const isRtl = getComputedStyle(this).direction === "rtl";
        const forwards = isRtl ? isLeft : isRight;
        ...
        if (forwards && isTrailingFocused || !forwards && isPrimaryFocused) // Moving outside of the chip, it will be handled by the chip set.
        return;
        // Prevent default interactions, such as scrolling.
        event.preventDefault();
    ...
    handleTrailingActionFocus() {
        ...
        if (!primaryAction || !trailingAction) return;
 ...
 * Copyright 2023 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 */ /** @protected */ function renderRemoveButton({ ariaLabel, disabled, focusListener, tabbable = false }) {
    return x`
    <button
 ...
 */ class FilterChip extends MultiActionChip {
    ...
    renderLeadingIcon() {
        if (!this.selected) return super.renderLeadingIcon();
        return x`
    ...
    renderTrailingAction(focusListener) {
        if (this.removable) return renderRemoveButton({
            focusListener,
 ...
 */ class InputChip extends MultiActionChip {
    ...
    get primaryAction() {
        ...
        if (this.removeOnly) return null;
   ...
   */ async close(returnValue = this.returnValue) {
    ...
    firstUpdated() {
        this.intersectionObserver = new IntersectionObserver((entries)=>{
            for (const entry of entries)this.handleAnchorIntersection(entry);
        }, {
            root: this.scroller
        });
    ...
    handleCancel(event) {
        if (event.target !== this.dialog) // Ignore any cancel events dispatched by content.
        return;
        this.escapePressedWithoutCancel = false;
        const preventDefault = !redispatchEvent(this, event);
    ...
    handleClose() {
        if (!this.escapePressedWithoutCancel) return;
        this.escapePressedWithoutCancel = false;
    ...
    async animateDialog(animation) {
        ...
        if (!dialog || !scrim || !container || !headline || !content || !actions) return;
        ...
        const animations = [];
        for (const [element, animation] of elementAndAnimation)for (const animateArgs of animation){
    ...
    handleAnchorIntersection(entry) {
        ...
        if (target === this.topAnchor) this.isAtScrollTop = isIntersecting;
        if (target === this.bottomAnchor) this.isAtScrollBottom = isIntersecting;
    }
...
/** @nocollapse */ SharedFab.shadowRootOptions = {
    mode: "open",
    delegatesFocus: true
};
__decorate([
 ...
 */ class Field extends s$1 {
    ...
    get counterText() {
        ...
        if (countAsNumber < 0 || maxAsNumber <= 0) return "";
   ...
   */ reannounceError() {
    ...
    update(props) {
        ...
        if (isDisabledChanging) this.disableTransitions = true;
    ...
    updated(changed) {
        if (changed.has("supportingText") || changed.has("errorText") || changed.has("count") || changed.has("max")) this.updateSlottedAriaDescribedBy();
        if (this.refreshErrorAlert) // The past render cycle removed the role="alert" from the error message.
        // Re-add it after an animation frame to re-announce the error.
        requestAnimationFrame(()=>{
            this.refreshErrorAlert = false;
        });
        if (this.disableTransitions) requestAnimationFrame(()=>{
            this.disableTransitions = false;
        });
    }
    renderSupportingText() {
        const { supportingOrErrorText, counterText } = this;
        if (!supportingOrErrorText && !counterText) return T;
    ...
    renderLabel(isFloating) {
        if (!this.label) return T;
        let visible;
        if (isFloating) // Floating label is visible when focused/populated or when animating.
        visible = this.focused || this.populated || this.isAnimating;
        else // Resting label is visible when unfocused. It is never visible while
        // animating.
        visible = !this.focused && !this.populated && !this.isAnimating;
        const classes = {
            hidden: !visible,
    ...
    getLabelKeyframes() {
        ...
        if (this.focused || this.populated) return [
            {
 ...
 */ class IconButton extends iconButtonBaseClass {
   ...
   */ willUpdate() {
    ...
    render() {
        ...
        if (!this.href) ariaLabelValue = hasToggledAriaLabel && this.selected ? this.ariaLabelSelected : ariaLabel;
        return n$2`<${tag}
...
/** @nocollapse */ IconButton.formAssociated = true;
/** @nocollapse */ IconButton.shadowRootOptions = {
    mode: "open",
    delegatesFocus: true
};
__decorate([
...
MdFilledTonalIconButton.styles = [
    styles$q,
    styles$p
];
 ...
 */ function deactivateActiveItem(items, isActivatable = isItemNotDisabled) {
    ...
    if (activeItem) activeItem.item.tabIndex = -1;
    return activeItem;
}
/**
 ...
 */ function getActiveItem(items, isActivatable = isItemNotDisabled) {
    for(let i = 0; i < items.length; i++){
        const item = items[i];
        if (item.tabIndex === 0 && isActivatable(item)) return {
            item,
            index: i
        };
    }
 ...
 */ function getNextItem(items, index, isActivatable = isItemNotDisabled, wrap = true) {
    for(let i = 1; i < items.length; i++){
        ...
        if (nextIndex < index && !wrap) // Return if the index loops back to the beginning and not wrapping.
        return null;
 ...
 */ function getPrevItem(items, index, isActivatable = isItemNotDisabled, wrap = true) {
    for(let i = 1; i < items.length; i++){
        ...
        if (prevIndex > index && !wrap) // Return if the index loops back to the end and not wrapping.
        return null;
 ...
 */ function activateNextItem(items, activeItemRecord, isActivatable = isItemNotDisabled, wrap = true) {
    if (activeItemRecord) {
        ...
        return next;
    } else return activateFirstItem(items, isActivatable);
}
/**
 ...
 */ function activatePreviousItem(items, activeItemRecord, isActivatable = isItemNotDisabled, wrap = true) {
    if (activeItemRecord) {
        ...
        return prev;
    } else return activateLastItem(items, isActivatable);
}
/**
 ...
 */ class ListController {
     ...
     */ this.handleKeydown = (event)=>{
            const key = event.key;
            if (event.defaultPrevented || !this.isNavigableKey(key)) return;
            ...
            if (nextActiveItem && activeItemRecord && activeItemRecord.item !== nextActiveItem) // If a new item was activated, remove the tabindex of the previous
            // activated item.
     ...
     */ this.onDeactivateItems = ()=>{
            const items = this.items;
            for (const item of items)this.deactivateItem(item);
        };
        /**
   ...
   */ get items() {
        ...
        for (const itemOrParent of maybeItems){
            ...
            if (subItem && this.isItem(subItem)) items.push(subItem);
        }
        return items;
    }
    /**
   ...
   */ activateNextItem() {
        const items = this.items;
        const activeItemRecord = getActiveItem(items, this.isActivatable);
        if (activeItemRecord) activeItemRecord.item.tabIndex = -1;
 ...
 */ class Item extends s$1 {
    ...
    handleTextSlotChange() {
        ...
        for (const slot of this.textSlots){
            if (slotHasContent(slot)) slotsWithContent += 1;
...
function slotHasContent(slot) {
    for (const node of slot.assignedNodes({
        ...
        if (isElement || isTextWithContent) return true;
    }
    return false;
}
/**
...
/** @nocollapse */ ListItemEl.shadowRootOptions = {
    ...s$1.shadowRootOptions,
    delegatesFocus: true
};
__decorate([
 ...
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */ const n$1 = "important", i = " !" + n$1, o = e$2(class extends i$1 {
    constructor(t$1){
 ...
 */ class SurfacePositionController {
   ...
   */ async position() {
        ...
        if (surfaceEl.popover && surfaceEl.isConnected) surfaceEl.showPopover();
     ...
     */ // Calculate the block positioning properties
        ...
        if (repositionStrategy === "resize") {
            ...
            if (blockOutOfBoundsCorrection) this.surfaceStylesInternal["height"] = `${surfaceRect.height - blockOutOfBoundsCorrection}px`;
            // Add a width property to the styles if there is block height correction
            if (inlineOutOfBoundsCorrection) this.surfaceStylesInternal["width"] = `${surfaceRect.width - inlineOutOfBoundsCorrection}px`;
        }
        this.host.requestUpdate();
    }
    /**
   ...
   */ calculateInline(config) {
        ...
        if (positioning === "document" || positioning === "fixed") {
            if (surfaceInline === "start" && isLTRBool || surfaceInline === "end" && !isLTRBool) surfaceInlineProperty = "left";
            else surfaceInlineProperty = "right";
        }
        return {
            inlineInset,
   ...
   */ close() {
        ...
        // and open source.
        if (surfaceEl?.popover && surfaceEl?.isConnected) surfaceEl.hidePopover();
    }
}
/**
 * @license
 ...
 */ class TypeaheadController {
   ...
   */ constructor(getProperties){
     ...
     */ this.onKeydown = (event)=>{
            if (this.isTypingAhead) this.typeahead(event);
            else this.beginTypeahead(event);
        };
        /**
   ...
   */ beginTypeahead(event) {
        ...
        if (event.code === "Space" || event.code === "Enter" || event.code.startsWith("Arrow") || event.code === "Escape") return;
        ...
        if (this.lastActiveRecord) this.lastActiveRecord[TYPEAHEAD_RECORD.ITEM].tabIndex = -1;
   ...
   */ typeahead(event) {
     ...
     */ const rebaseIndexOnActive = (record)=>{
        ...
        if (this.lastActiveRecord === matchingRecords[0] && isNewQuery) nextRecord = matchingRecords[1] ?? matchingRecords[0];
        else nextRecord = matchingRecords[0];
        if (this.lastActiveRecord) this.lastActiveRecord[TYPEAHEAD_RECORD.ITEM].tabIndex = -1;
 ...
 */ function getFocusedElement(activeDoc = document) {
    ...
    while(activeEl && activeEl?.shadowRoot?.activeElement)activeEl = activeEl.shadowRoot.activeElement;
    return activeEl;
}
/**
 ...
 */ class Menu extends s$1 {
   ...
   */ get anchorElement() {
        if (this.anchor) return this.getRootNode().querySelector(`#${this.anchor}`);
     ...
     */ this.isRepositioning = false;
        ...
        this.listController = new ListController({
            ...
            isNavigableKey: (key)=>{
                if (!this.isSubmenu) return menuNavKeys.has(key);
                const isRtl = getComputedStyle(this).direction === "rtl";
     ...
     */ this.menuPositionController = new SurfacePositionController(this, ()=>{
        ...
        this.onWindowResize = ()=>{
            if (this.isRepositioning || this.positioning !== "document" && this.positioning !== "fixed" && this.positioning !== "popover") return;
        ...
        this.handleFocusout = async (event)=>{
            ...
            // not focus buttons.
            if (this.stayOpenOnFocusout || !this.open || this.pointerPath.includes(anchorEl)) return;
            if (event.relatedTarget) {
                ...
                if (isElementInSubtree(event.relatedTarget, this) || this.pointerPath.length !== 0 && isElementInSubtree(event.relatedTarget, anchorEl)) return;
            } else if (this.pointerPath.includes(this)) // If menu tabindex == -1 and the user clicks on the menu or a divider, we
     ...
     */ this.onOpened = async ()=>{
            ...
            if (activeItemRecord && this.defaultFocus !== FocusState.NONE) activeItemRecord.item.tabIndex = -1;
            let animationAborted = !this.quick;
            if (this.quick) this.dispatchEvent(new Event("opening"));
            else animationAborted = !!await this.animateOpen();
            ...
            if (!animationAborted) this.dispatchEvent(new Event("opened"));
        };
        /**
     * Animates closed.
     */ this.beforeClose = async ()=>{
            this.open = false;
            if (!this.skipRestoreFocus) this.lastFocusedElement?.focus?.();
            if (!this.quick) await this.animateClose();
        };
        /**
     ...
     */ this.onDocumentClick = (event)=>{
            ...
            if (!this.stayOpenOnOutsideClick && !path.includes(this) && !path.includes(this.anchorElement)) this.open = false;
        };
   ...
   */ get items() {
    ...
    update(changed) {
        if (changed.has("open")) {
            if (this.open) this.setUpGlobalEventListeners();
            else this.cleanUpGlobalEventListeners();
        }
        // Firefox does not support popover. Fall-back to using fixed.
        if (changed.has("positioning") && this.positioning === "popover" && // type required for Google JS conformance
        !this.showPopover) this.positioning = "fixed";
        super.update(changed);
    }
    connectedCallback() {
        super.connectedCallback();
   ...
   */ reposition() {
        if (this.open) this.menuPositionController.position();
    }
}
__decorate([
    e$5(".menu")
 ...
 */ class MenuItemController {
   ...
   */ constructor(host, config){
     ...
     */ this.onKeydown = (event)=>{
            ...
            if (this.host.href && event.code === "Enter") {
                ...
                if (interactiveElement instanceof HTMLAnchorElement) interactiveElement.click();
            }
            if (event.defaultPrevented) return;
   ...
   */ get typeaheadText() {
        ...
        headlineElements.forEach((headlineElement)=>{
            if (headlineElement.textContent && headlineElement.textContent.trim()) textParts.push(headlineElement.textContent.trim());
        });
        // If there are no headline elements, check the default slot's text content
        if (textParts.length === 0) this.getDefaultElements().forEach((defaultElement)=>{
            if (defaultElement.textContent && defaultElement.textContent.trim()) textParts.push(defaultElement.textContent.trim());
        });
        // If there are no headline nor default slot elements, check the
        //supporting-text slot's text content
        if (textParts.length === 0) this.getSupportingTextElements().forEach((supportingTextElement)=>{
            if (supportingTextElement.textContent && supportingTextElement.textContent.trim()) textParts.push(supportingTextElement.textContent.trim());
        });
   ...
   */ get role() {
    ...
    hostUpdate() {
        if (this.host.href) this.host.type = "link";
    }
    /**
...
/** @nocollapse */ MenuItemEl.shadowRootOptions = {
    ...s$1.shadowRootOptions,
    delegatesFocus: true
};
__decorate([
 ...
 */ class SubMenu extends s$1 {
     ...
     */ this.onMouseenter = ()=>{
            ...
            if (!this.hoverOpenDelay) this.show();
            else this.previousOpenTimeout = setTimeout(()=>{
                this.show();
            }, this.hoverOpenDelay);
        };
        /**
     ...
     */ this.onMouseleave = ()=>{
            ...
            // would never resolve otherwise)
            if (!this.hoverCloseDelay) this.close();
            else this.previousCloseTimeout = setTimeout(()=>{
                this.close();
   ...
   */ async show() {
        ...
        if (menu.positioning === "document") menu.positioning = "absolute";
        menu.quick = true;
        ...
        if (menu.id) this.item.setAttribute("aria-controls", menu.id);
        ...
        if (!menuAlreadyOpen) {
            ...
            menu.addEventListener("opened", open, {
                once: true
            });
            await opened;
        }
   ...
   */ async close() {
        ...
        menu.addEventListener("closed", close, {
            once: true
        });
        await closed;
    }
    onSlotchange() {
        ...
        this.item.ariaExpanded = "false";
        this.item.ariaHasPopup = "menu";
        if (this.menu?.id) this.item.setAttribute("aria-controls", this.menu.id);
   ...
   */ async onKeydown(event) {
        ...
        if (event.code === SelectionKey.SPACE || openedWithLR) {
            ...
            event.preventDefault();
            if (openedWithLR) event.stopPropagation();
        }
        if (!shouldOpenSubmenu) return;
    ...
    async onSubMenuKeydown(event) {
        ...
        event.preventDefault();
        if (keyCode === NavigableKey.LEFT || keyCode === NavigableKey.RIGHT) // Prevent this from bubbling to parents
        event.stopPropagation();
        await this.close();
 ...
 */ class CircularProgress extends Progress {
    renderIndicator() {
        if (this.indeterminate) return this.renderIndeterminateContainer();
 ...
 */ function mixinFocusable(base) {
    ...
    class FocusableElement extends base {
        ...
        set [isFocusable](value) {
            if (this[isFocusable] === value) return;
        ...
        attributeChangedCallback(name, old, value) {
            ...
            if (this[isUpdatingTabIndex]) // Not an externally-initiated update.
            return;
 ...
 */ class RadioValidator extends Validator {
    ...
    equals(prevGroup, nextGroup) {
        ...
        for(let i = 0; i < prevGroup.length; i++){
            ...
            if (prev.checked !== next.checked || prev.required !== next.required) return false;
        }
        return true;
    }
    copy(states) {
 ...
 */ class SingleSelectionController {
   ...
   */ get controls() {
        ...
        if (!name || !this.root || !this.host.isConnected) return [
            this.host
        ];
     ...
     */ this.handleKeyDown = (event)=>{
            ...
            while(nextIndex !== hostIndex){
                if (nextIndex >= siblings.length) // Return to start if moving past the last item.
                nextIndex = 0;
                else if (nextIndex < 0) // Go to end if moving before the first item.
                ...
                for (const sibling of siblings)if (sibling !== nextSibling) {
    ...
    hostConnected() {
        ...
        if (this.host.checked) // Uncheck other siblings when attached if already checked. This mimics
   ...
   */ handleCheckedChange() {
    ...
    uncheckSiblings() {
        for (const sibling of this.controls)if (sibling !== this.host) sibling.checked = false;
    }
    /**
   ...
   */ updateTabIndices() {
        ...
        if (checkedSibling || this.focused) {
            ...
            for (const sibling of siblings)if (sibling !== focusable) sibling.tabIndex = -1;
            return;
        }
        // 3. If none are checked or focused, all are focusable.
        for (const sibling of siblings)sibling.tabIndex = 0;
    }
}
/**
 * @license
   ...
   */ get checked() {
    ...
    [createValidator]() {
        return new RadioValidator(()=>{
            if (!this.selectionController) // Validation runs on superclass construction, so selection controller
    ...
    class OnReportValidityElement extends base {
       ...
       */ this[_c] = false;
            this.addEventListener("invalid", (invalidEvent)=>{
                ...
                // trusted.
                if (this[privateDoNotReportInvalid] || !invalidEvent.isTrusted) return;
        ...
        reportValidity() {
            ...
            if (valid) this[privateCallOnReportValidity](null);
        ...
        [(_a = privateCleanupFormListeners, _b = privateDoNotReportInvalid, _c = privateIsSelfReportingValidity, privateCallOnReportValidity)](invalidEvent) {
            ...
            //   invalid control.
            if (this[privateIsSelfReportingValidity] || isFirstInvalidControlInForm(this[internals].form, this)) this.focus();
        }
        ...
        formAssociatedCallback(form) {
            ...
            if (super.formAssociatedCallback) super.formAssociatedCallback(form);
 ...
 */ function isFirstInvalidControlInForm(form, control) {
    ...
    for (const element of form.elements)if (element.matches(":invalid")) {
 ...
 */ class SelectValidator extends Validator {
    computeValidity(state) {
        if (!this.selectControl) // Lazily create the platform select
 ...
 */ function getSelectedItems(items) {
    ...
    for(let i = 0; i < items.length; i++){
        const item = items[i];
        if (item.selected) selectedItemRecords.push([
            item,
            i
        ]);
    }
 ...
 */ class Select extends selectBaseClass {
   ...
   */ select(value) {
        ...
        if (optionToSelect) this.selectItem(optionToSelect);
    }
    /**
   ...
   */ reset() {
        for (const option of this.options)option.selected = option.hasAttribute("selected");
    ...
    [(_a$1 = VALUE, onReportValidity)](invalidEvent) {
        ...
        if (prevMessage === this.getErrorText()) this.field?.reannounceError();
    }
    update(changed) {
    ...
    async firstUpdated(changed) {
        ...
        if (!this.lastSelectedOptionRecords.length) this.initUserSelection();
        // Case for when the DOM is streaming, there are no children, and a child
        // has [selected] set on it, we need to wait for DOM to render something.
        if (!this.lastSelectedOptionRecords.length && !o$2 && !this.options.length) setTimeout(()=>{
            this.updateValueAndDisplayText();
        });
        super.firstUpdated(changed);
    }
   ...
   */ handleKeydown(event) {
        ...
        if (isPrintableKey) {
            ...
            if (!lastActiveRecord) return;
            this.labelEl?.setAttribute?.("aria-live", "polite");
            const hasChanged = this.selectItem(lastActiveRecord[TYPEAHEAD_RECORD.ITEM]);
            if (hasChanged) this.dispatchInteractionEvents();
        }
    }
    handleClick() {
        this.open = !this.open;
   ...
   */ handleFocusout(event) {
        ...
        if (event.relatedTarget && isElementInSubtree(event.relatedTarget, this)) return;
        this.open = false;
    }
    /**
   ...
   */ async handleOpening(e) {
        ...
        // last selected item.
        if (this.defaultFocus !== FocusState.NONE) return;
        const items = this.menu.items;
        const activeItem = getActiveItem(items)?.item;
        let [selectedItem] = this.lastSelectedOptionRecords[0] ?? [
            null
        ];
        // This is true if the user keys through the list but clicks out of the menu
        // thus no close-menu event is fired by an item and we can't clean up in
        // handleCloseMenu.
        if (activeItem && activeItem !== selectedItem) activeItem.tabIndex = -1;
   ...
   */ handleCloseMenu(event) {
        ...
        this.open = false;
        let hasChanged = false;
        if (reason.kind === "click-selection") hasChanged = this.selectItem(item);
        else if (reason.kind === "keydown" && isSelectableKey(reason.key)) hasChanged = this.selectItem(item);
        else {
   ...
   */ selectItem(item) {
        ...
        selectedOptions.forEach(([option])=>{
            if (item !== option) option.selected = false;
        });
        item.selected = true;
   ...
   */ handleRequestSelection(event) {
        ...
        if (this.lastSelectedOptionRecords.some(([option])=>option === requestingOptionEl)) return;
   ...
   */ initUserSelection() {
        ...
        if (this.lastUserSetValue && !this.lastSelectedOptionRecords.length) this.select(this.lastUserSetValue);
        else if (this.lastUserSetSelectedIndex !== null && !this.lastSelectedOptionRecords.length) this.selectIndex(this.lastUserSetSelectedIndex);
        else this.updateValueAndDisplayText();
    }
    handleIconChange() {
...
/** @nocollapse */ Select.shadowRootOptions = {
    ...s$1.shadowRootOptions,
    delegatesFocus: true
};
__decorate([
 ...
 */ class SelectOptionController {
   ...
   * _default_.
   */ get displayText() {
        if (this.internalDisplayText !== null) return this.internalDisplayText;
        return this.menuItemController.typeaheadText;
    }
    setDisplayText(text) {
   ...
   */ constructor(host, config){
    ...
    hostUpdate() {
        if (this.lastSelected !== this.host.selected) this.host.ariaSelected = this.host.selected ? "true" : "false";
    }
    hostUpdated() {
        ...
        if (this.lastSelected !== this.host.selected && !this.firstUpdate) {
            ...
            if (this.host.selected) this.host.dispatchEvent(createRequestSelectionEvent());
            else this.host.dispatchEvent(createRequestDeselectionEvent());
        }
        this.lastSelected = this.host.selected;
...
/** @nocollapse */ SelectOptionEl.shadowRootOptions = {
    ...s$1.shadowRootOptions,
    delegatesFocus: true
};
__decorate([
 ...
 */ class Slider extends sliderBaseClass {
   ...
   */ get nameEnd() {
    ...
    get renderAriaLabelEnd() {
        // Needed for closure conformance
        const { ariaLabel } = this;
        if (this.range) return this.ariaLabelEnd || ariaLabel && `${ariaLabel} end` || this.valueLabelEnd || String(this.valueEnd);
        return ariaLabel || this.valueLabel || String(this.value);
    }
    get renderAriaValueTextEnd() {
        if (this.range) return this.ariaValueTextEnd || this.valueLabelEnd || String(this.valueEnd);
     ...
     */ this.range = false;
        ...
        this.addEventListener("click", (event)=>{
            if (!isActivationClick(event) || !this.inputEnd) return;
            this.focus();
    ...
    willUpdate(changed) {
        ...
        // none.
        if (changed.get("handleStartHover") !== undefined) this.toggleRippleHover(this.rippleStart, this.handleStartHover);
        else if (changed.get("handleEndHover") !== undefined) this.toggleRippleHover(this.rippleEnd, this.handleEndHover);
    }
    updated(changed) {
        ...
        if (this.range) this.renderValueStart = this.inputStart.valueAsNumber;
    ...
    async toggleRippleHover(ripple, hovering) {
        ...
        if (hovering) rippleEl.handlePointerenter(new PointerEvent("pointerenter", {
            isPrimary: true,
            pointerId: this.ripplePointerId
        }));
        else rippleEl.handlePointerleave(new PointerEvent("pointerleave", {
            isPrimary: true,
            pointerId: this.ripplePointerId
        }));
    }
    ...
    async handleUp(event) {
        ...
        if (target !== undefined) {
            ...
            if (flipped && target.valueAsNumber !== values.get(target)) target.dispatchEvent(new Event("change", {
                bubbles: true
            }));
        }
        this.finishAction(event);
   ...
   */ handleMove(event) {
    ...
    clampAction() {
        if (!this.needsClamping() || !this.action) return false;
        const { target, fixed } = this.action;
        target.valueAsNumber = fixed.valueAsNumber;
        return true;
    }
    handleInput(event) {
        ...
        } else this.value = this.inputEnd.valueAsNumber;
...
/** @nocollapse */ Slider.shadowRootOptions = {
    ...s$1.shadowRootOptions,
    delegatesFocus: true
};
__decorate([
...
/** @nocollapse */ Switch.shadowRootOptions = {
    mode: "open",
    delegatesFocus: true
};
__decorate([
 ...
 */ class Tab extends tabBaseClass {
   ...
   */ get selected() {
    ...
    [(_a = INDICATOR, ANIMATE_INDICATOR)](previousTab) {
        ...
        if (frames !== null) this[INDICATOR].animate(frames, {
            duration: 250,
            easing: EASING.EMPHASIZED
        });
    }
    getKeyframes(previousTab) {
        ...
        if (!this.active) return reduceMotion ? [
            {
                opacity: 1
            },
            {
        ...
        if (!reduceMotion && fromPos !== undefined && toPos !== undefined && !isNaN(scale)) from["transform"] = `translateX(${(fromPos - toPos).toFixed(4)}px) scaleX(${scale.toFixed(4)})`;
        else from["opacity"] = 0;
    ...
    handleSlotChange() {
        ...
        for (const node of this.assignedDefaultNodes){
            ...
            if (node.nodeType === Node.ELEMENT_NODE || hasTextContent) return;
        }
        this.iconOnly = true;
    }
 ...
 */ class Tabs extends s$1 {
   ...
   */ async scrollToTab(tabToScrollTo) {
        ...
        if (!tabToScrollTo || !tabs.includes(tabToScrollTo) || !this.tabsScrollerElement) return;
        // wait for tabs to render.
        for (const tab of this.tabs)await tab.updateComplete;
        ...
        this.tabsScrollerElement.scrollTo({
            behavior,
            top: 0,
            left: to
        });
    ...
    activateTab(activeTab) {
        ...
        if (!tabs.includes(activeTab) || previousTab === activeTab) // Ignore setting activeTab to a tab element that is not a child.
        return;
        for (const tab of tabs)tab.active = tab === activeTab;
        if (previousTab) {
            ...
            const defaultPrevented = !this.dispatchEvent(new Event("change", {
                bubbles: true,
                cancelable: true
            }));
            if (defaultPrevented) {
                for (const tab of tabs)tab.active = tab === previousTab;
                return;
            }
    ...
    updateFocusableTab(focusableTab) {
        for (const tab of this.tabs)tab.tabIndex = tab === focusableTab ? 0 : -1;
    }
    ...
    async handleKeydown(event) {
        ...
        const isEnd = event.key === "End";
        // Ignore non-navigation keys
        if (event.defaultPrevented || !isLeft && !isRight && !isHome && !isEnd) return;
        const { tabs } = this;
        ...
        event.preventDefault();
        let indexToFocus;
        if (isHome || isEnd) indexToFocus = isHome ? 0 : tabs.length - 1;
        else {
            // Check if moving forwards or backwards
            const isRtl = getComputedStyle(this).direction === "rtl";
            const forwards = isRtl ? isLeft : isRight;
            const { focusedTab } = this;
            if (!focusedTab) // If there is not already a tab focused, select the first or last tab
            // based on the direction we're traveling.
            indexToFocus = forwards ? 0 : tabs.length - 1;
            else {
                const focusedIndex = this.tabs.indexOf(focusedTab);
                indexToFocus = forwards ? focusedIndex + 1 : focusedIndex - 1;
                if (indexToFocus >= tabs.length) // Return to start if moving past the last item.
                indexToFocus = 0;
                else if (indexToFocus < 0) // Go to end if moving before the first item.
                indexToFocus = tabs.length - 1;
            }
        }
        const tabToFocus = tabs[indexToFocus];
        tabToFocus.focus();
        if (this.autoActivate) this.activateTab(tabToFocus);
        else this.updateFocusableTab(tabToFocus);
    }
    ...
    handleFocusout() {
        ...
        if (activeTab) this.updateFocusableTab(activeTab);
    }
    handleSlotChange() {
        const firstTab = this.tabs[0];
        if (!this.activeTab && firstTab) // If the active tab was removed, auto-select the first one. There should
 ...
 */ class TextFieldValidator extends Validator {
    computeValidity({ state, renderedControl }) {
        ...
        if (input) input.type = state.type;
        if (inputOrTextArea.value !== state.value) // Only programmatically set the value if there's a difference. When using
        ...
        if (input) {
            ...
            if (inputState.pattern) input.pattern = inputState.pattern;
            else input.removeAttribute("pattern");
            if (inputState.min) input.min = inputState.min;
            else input.removeAttribute("min");
            if (inputState.max) input.max = inputState.max;
            else input.removeAttribute("max");
            if (inputState.step) input.step = inputState.step;
        ...
        if ((state.minLength ?? -1) > -1) inputOrTextArea.setAttribute("minlength", String(state.minLength));
        else inputOrTextArea.removeAttribute("minlength");
        if ((state.maxLength ?? -1) > -1) inputOrTextArea.setAttribute("maxlength", String(state.maxLength));
        else inputOrTextArea.removeAttribute("maxlength");
        return {
    ...
    equals({ state: prev }, { state: next }) {
        ...
        if (!isInputState(prev) || !isInputState(next)) // Both are textareas, all relevant properties are equal.
 ...
 */ class TextField extends textFieldBaseClass {
   ...
   */ reset() {
    ...
    attributeChangedCallback(attribute, newValue, oldValue) {
        if (attribute === "value" && this.dirty) // After user input, changing the value attribute no longer updates the
    ...
    updated(changedProperties) {
        ...
        if (this.value !== value) // Note this is typically inefficient in updated() since it schedules
    ...
    renderInputOrTextarea() {
        ...
        if (this.type === "textarea") return x`
        <textarea
          class="input"
          style=${o(style)}
          aria-describedby="description"
    ...
    getInputOrTextarea() {
        ...
        if (this.isUpdatePending) // If there are pending updates, synchronously perform them. This ensures
    ...
    getInput() {
        if (this.type === "textarea") return null;
...
/** @nocollapse */ TextField.shadowRootOptions = {
    ...s$1.shadowRootOptions,
    delegatesFocus: true
};
__decorate([
 ...
 */ class HctSolver {
   ...
   */ static solveToInt(hueDegrees, chroma, lstar) {
        if (chroma < 0.0001 || lstar < 0.0001 || lstar > 99.9999) return argbFromLstar(lstar);
 ...
 */ class DislikeAnalyzer {
   ...
   */ static fixIfDisliked(hct) {
        if (DislikeAnalyzer.isDisliked(hct)) return Hct.from(hct.hue, hct.chroma, 70.0);
        return hct;
    }
}
/**
 ...
 */ class ContrastCurve {
   ...
   */ getContrast(contrastLevel) {
        ...
        else if (contrastLevel < 0.0) return lerp(this.low, this.normal, (contrastLevel - -1) / 1);
        else if (contrastLevel < 0.5) return lerp(this.normal, this.medium, (contrastLevel - 0) / 0.5);
        else if (contrastLevel < 1.0) return lerp(this.medium, this.high, (contrastLevel - 0.5) / 0.5);
...
function performAlbers(prealbers, scheme) {
    ...
    if (DynamicColor.tonePrefersLightForeground(prealbers.tone) && !DynamicColor.toneAllowsLightForeground(albersd.tone)) return DynamicColor.enableLightForeground(prealbers.tone);
    else return DynamicColor.enableLightForeground(albersd.tone);
}
/**
...
},{}]},["4iOC0","jeTEc"], "jeTEc", "parcelRequire94c2")

//# sourceMappingURL=home.4510300f.js.map
